    ...
    return (
        ...
        <div className="Closet CtPop">
            ...
            <div className="popCon">
                    ...
                    <div className="nav nav-tabs">
                        ...
                        <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}>
                            <div className={`iconbg ${View === 1 ? 'on' : null }`} onClick={(e) => {setView(1);}}>
                                <img src={`/resources/img/${View === 1 ? 'clothes_color_on' : 'clothes_color_off' }.png`} alt="칼라 선택 아이콘 버튼 이미지" />
                            </div>
                    ...
                    <div className="myroom-itemboxs">
                        { View === 0 ? (                        
                            <div className="itembox">
                                <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}><img src="/resources/img/myroom_items.png" alt="마이룸 아이템 이미지" /></button>
                                <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}><img src="/resources/img/myroom_items.png" alt="마이룸 아이템 이미지" /></button>
                                <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}><img src="/resources/img/myroom_items.png" alt="마이룸 아이템 이미지" /></button>
                                <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}><img src="/resources/img/myroom_items.png" alt="마이룸 아이템 이미지" /></button>
                                <button type="button" className={`nav-item ${View02 ? 'on' : null }`} onClick={() => {setView02(!View02)}}><img src="/resources/img/myroom_items.png" alt="마이룸 아이템 이미지" /></button>
                ...
                <div className="con-right"><img src="/resources/img/character.png" alt="캐릭터 이미지" /></div>
            </div>
